...
function buildClaudeConfig(entry: {
  ...
  return {
    ...
    model: entry.model || process.env.CODEX_MODEL || process.env.CLAUDE_MODEL || process.env.ANTHROPIC_MODEL || undefined,
...
function feishuBotFromEnv(): BotConfig {
  return {
    ...
    claude: {
      ...
      model: process.env.CODEX_MODEL || process.env.CLAUDE_MODEL || undefined,
